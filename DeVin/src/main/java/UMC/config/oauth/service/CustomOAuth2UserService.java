package UMC.config.oauth.service;
...
import UMC.config.oauth.exception.OAuthProviderMissMatchException;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User process(OAuth2UserRequest userRequest, OAuth2User user) {
        ...
        Optional<Member> savedUser = userRepository.findByEmail(userInfo.getId());
